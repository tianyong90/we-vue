...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__swipe_vue__ = __webpack_require__(265);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__swipe_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__swipe_vue__);
/* harmony reexport (default from non-hamory) */ __webpack_require__.d(__webpack_exports__, "default", function() { return __WEBPACK_IMPORTED_MODULE_0__swipe_vue___default.a; });
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_dom_js__ = __webpack_require__(137);
  ...
  mounted: function mounted() {
    ...
    if (this.auto > 0) {
      this.timer = setInterval(function () {
        if (!_this.continuous && _this.index >= _this.pages.length - 1) {
  ...
  methods: {
    ...
    translate: function translate(element, offset, speed, callback) {
      ...
      if (speed) {
        ...
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils_dom_js__["a" /* once */])(element, 'webkitTransitionEnd', transitionEndCallback);
    ...
    reInitPages: function reInitPages() {
      ...
      children.forEach(function (child, index) {
        ...
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils_dom_js__["b" /* removeClass */])(child.$el, 'is-active');

        if (index === defaultIndex) {
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils_dom_js__["c" /* addClass */])(child.$el, 'is-active');
        }
      });
    ...
    doAnimate: function doAnimate(towards, options) {
      ...
      var callback = function callback() {
        if (newIndex !== undefined) {
          ...
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils_dom_js__["b" /* removeClass */])(oldPage, 'is-active');
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils_dom_js__["c" /* addClass */])(newPage, 'is-active');
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "wv-swipe-indicators"
  }, _vm._l((_vm.pages), function(page, $index) {
    return _c('div', {
      staticClass: "wv-swipe-indicator",
      class: {
