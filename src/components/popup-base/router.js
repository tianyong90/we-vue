    ...
    if (window) {
      window.addEventListener('popstate', () => {
        ...
        if (this.history.prev === hash) {
          var lastParams = this.getUrlParams(this.history.pop())
          var params = this.getUrlParams(this.history.top)
        ...
        // 前进
          ...
          var params = this.getUrlParams(hash)
          var lastParams = this.getUrlParams(this.history.top)
