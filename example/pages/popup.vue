<template>
  <div class="page page-with-padding">
    <wv-button type="default" @click="popupVisible1 = true">
      默认弹出层
    </wv-button>
    <wv-button type="default" @click="popupVisible2 = true">
      指定高度为 300px
    </wv-button>
    <wv-button type="default" @click="popupVisible3 = true">
      指定高度 100%
    </wv-button>
    <wv-button type="default" @click="popupVisible4 = true">
      点击遮罩层不关闭
    </wv-button>
    <wv-button type="default" @click="popupVisible5 = true">
      自定义遮罩样式
    </wv-button>
